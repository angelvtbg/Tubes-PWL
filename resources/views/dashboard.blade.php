<x-app-layout>
    ...
    <style>
        .sub-logo {
            ...
            height: auto;
            /* Biarkan tingginya menyesuaikan proporsi */
        }
    </style>
                            ...
                            <div class="p-6 text-gray-900 dark:text-gray-100">
                                <div class="jumbotron dashboard">
                                    <div class="row">
                                        ...
                                        <center>
                                            <a href="{{ route('registrasiChef.index') }}" class="custom-button3">
                                                Registrasi Chef
                                            </a>
                                        </center>
                                    </div>
                                    ...
                                    <div class="newContent grid">
                                        <article class="newCard">
                                            <a href="{{ route('menuset.index') }}">
                                                <img src="{{ asset('images/recipe.png') }}" alt="image" class="newImg">
                                            </a>
                                        ...
                                        <article class="newCard">
                                            <a href="{{ route('pengguna.index') }}">
                                                <img src="{{ asset('images/user.png') }}" alt="image" class="newImg">
                                            </a>
                                        ...
                                        <article class="newCard">
                                            @if (Auth::check() && Auth::user()->role == 'admin')
                                                <a href="{{ route('admin.reservadmin') }}">
                                                    <img src="{{ asset('images/reservation.png') }}" alt="image"
                                                        class="newImg">
                                                </a>
                                        ...
                                        <article class="newCard">
                                            @if (Auth::check() && Auth::user()->role == 'admin')
                                                <a href="{{ route('order.admin') }}">
                                                    <img src="{{ asset('images/orderHistory.png') }}" alt="image"
                                                        class="newImg">
                                                </a>
                            ...
                            <div class="newContent grid">
                                ...
                                <article class="newCard">
                                    <a href="{{ route('history.reservhistory') }}">
                                        <img src="{{ asset('images/reservHistory.png') }}" alt="image" class="newImg">
                                    </a>
                                    <h2 class="newTitle">Reservation History</h2>
                                </article>
                                <article class="newCard">
                                    <a href="{{ route('order.history') }}">
                                        <img src="{{ asset('images/orderHistory.png') }}" alt="image" class="newImg">
                                    </a>
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 text-gray-900 dark:text-gray-100">
                                <div class="jumbotron dashboard">
                                    <div class="column">
                                        <div class="col-8">
                                            <h5 class="welcome">Wellcome, Chef {{ Auth::user()->name }} !!</h5>
                                        </div>

                                        <div class="ml-2 mr-5 col" style="width: 4rem;">
                                            <div class="card-title">
                                                <h1 class="mt-3 num" style="text-align: center;">{{ $jumlahMenu }}</h1>
                                                <p style="text-align: center;">Total Menu</p>
                                            </div>
